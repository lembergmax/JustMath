 ...
 * A summation token contains a start value, an end value, and a list of tokens representing the expression to be evaluated.
 */
@Getter
public class SummationToken extends Token {
     ...
     *
     * @param functionSymbol the function symbol (e.g., "sum" or "∑")
     * @param start the start value of the summation
     * @param end the end value of the summation
     * @param expressionTokens the list of tokens representing the expression to be evaluated
     */
    ...
    public String toString() {
        return "SUMMATION(start=" + start + ", end=" + end + ", tokens=" + expressionTokens + ")";
    }
}