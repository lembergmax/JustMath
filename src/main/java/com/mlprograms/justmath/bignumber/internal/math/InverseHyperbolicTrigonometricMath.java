...
import static com.mlprograms.justmath.bignumber.internal.BigNumbers.NEGATIVE_ONE;
...
public class InverseHyperbolicTrigonometricMath {
     ...
     * </pre>
     *
     * @param argument    the input value for which to compute asinh
     * @param mathContext the {@link MathContext} specifying precision and rounding behavior
     * @param locale      the {@link Locale} used for formatting the resulting {@link BigNumber}
     ...
     *
     * @param argument    the input value for which to compute acosh
     * @param mathContext the {@link MathContext} specifying precision and rounding behavior
     * @param locale      the {@link Locale} used for formatting the resulting {@link BigNumber}
     * @return a {@link BigNumber} representing acosh(argument) calculated with the specified precision
     * @throws ArithmeticException if the argument is outside the domain (absolute value >= 1)
     */
     ...
     *
     * @param argument    the input value for which to compute atanh
     * @param mathContext the {@link MathContext} specifying precision and rounding behavior
     * @param locale      the {@link Locale} used for formatting the resulting {@link BigNumber}
     ...
     * Domain restriction: {@code |x| > 1}.
     *
     * @param argument    the input value for which to compute acoth
     * @param mathContext the {@link MathContext} specifying precision and rounding behavior
     * @param locale      the {@link Locale} used for formatting the resulting {@link BigNumber}
    ...
    public static BigNumber acoth(@NonNull final BigNumber argument, @NonNull final MathContext mathContext, @NonNull final Locale locale) {
        if (argument.isLessThanOrEqualTo(ONE)) {
            throw new IllegalArgumentException("argument must be greater than 1");
        }
