...
public class BigNumber extends Number implements Comparable<BigNumber> {
     ...
     *
     * @param number the numeric string to parse (auto-detected format, non-null)
     */
     ...
     *
     * @param number the numeric string to parse (non-null)
     * @param locale the locale to use for parsing decimal separators, grouping, etc. (non-null)
     */
     ...
     *
     * @param number      the numeric string to parse (auto-detected format, non-null)
     * @param mathContext the precision and rounding mode to apply (non-null)
     */
     ...
     *
     * @param number     the numeric string to parse (non-null)
     * @param fromLocale the locale to interpret the input string (non-null)
     * @param toLocale   the locale to re-format the parsed value (non-null)
     */
     ...
     *
     * @param other the instance to copy (non-null)
     */
     ...
     *
     * @param other     the instance to copy (non-null)
     * @param newLocale the locale to apply to the copied value (non-null)
     */
     ...
     *
     * @param other       the instance to copy (non-null)
     * @param newLocale   the locale to apply (non-null)
     * @param mathContext the precision and rounding mode to apply (non-null)
     */
     ...
     *
     * @param locale             the locale used for formatting and parsing (non-null)
     * @param valueBeforeDecimal the digits before the decimal point as a string (non-null)
     * @param valueAfterDecimal  the digits after the decimal point as a string (non-null)
     ...
     *
     * @param locale             the locale for formatting and parsing (non-null)
     * @param valueBeforeDecimal the digits before the decimal point (non-null)
     * @param valueAfterDecimal  the digits after the decimal point (non-null)
     * @param isNegative         whether the number is negative
     * @param mathContext        the precision and rounding mode (nullable; defaults if null)
     * @param trigonometricMode  the angle unit mode for trigonometric operations (nullable; defaults if null)
     */
    @Builder
    public BigNumber(
            @NonNull final Locale locale,
     ...
     *
     * @param bigDecimal the source {@code BigDecimal} (non-null)
     * @param locale     the locale to apply for formatting (non-null)
     */
     ...
     *
     * @param locale             the locale for formatting and parsing (non-null)
     * @param valueBeforeDecimal digits before the decimal point (non-null)
     * @param valueAfterDecimal  digits after the decimal point (non-null)
     * @param isNegative         whether the number is negative
     * @param trigonometricMode  the angle unit mode (non-null)
     */
    public BigNumber(
            @NonNull final Locale locale,
            @NonNull final String valueBeforeDecimal,
     ...
     *
     * @param other             the instance to copy (non-null)
     * @param mathContext       the new precision and rounding mode (non-null)
     * @param trigonometricMode the new angle unit mode (non-null)
     */
    public BigNumber(
     ...
     *
     * @param number            the numeric string to parse (non-null)
     * @param locale            the locale to use for parsing (non-null)
     * @param mathContext       the precision and rounding mode (non-null)
     * @param trigonometricMode the angle unit mode (non-null)
     */
    public BigNumber(
            @NonNull final String number,
     ...
     *
     * @param multiplier the number to multiply with this number
     ...
     *
     * @param divisor the divisor (must not be zero or negative)
     * @return a new {@code BigNumber} representing {@code this % divisor}
     * @throws IllegalArgumentException if the divisor is zero or if either number is negative
     */
     ...
     * @param exponent    the exponent
     * @param mathContext the context specifying precision and rounding mode
     * @param locale      the locale to apply for formatting or localization (if relevant)
     * @return a new {@code BigNumber} representing the result of the exponentiation
     */
     ...
     * @throws ArithmeticException if the number is not a non-negative integer or too large for computation
     */
     ...
     *
     * @param mathContext the context defining precision and rounding
     * @param locale      the locale for result formatting
     ...
     *
     * @param base the logarithm base (must be > 0)
     * @return a new {@code BigNumber} representing log₍base₎(this)
     * @throws IllegalArgumentException if {@code base} is zero or negative
     */
     ...
     *
     * @param base        the logarithm base (must be > 0)
     * @param mathContext the precision and rounding settings for both ln calculations and division
     * @param locale      the locale used for any locale-specific formatting
     * @return a new {@code BigNumber} representing log₍base₎(this)
     * @throws IllegalArgumentException if {@code base} is zero or negative
     */
     ...
     * <p>This is a convenience method that delegates to {@link #sin(MathContext, TrigonometricMode, Locale)}.</p>
     *
     * @param trigonometricMode whether the input is in degrees or radians
     * @return a new {@code BigNumber} representing sin(this)
     */
     ...
     *
     * @param mathContext       the precision and rounding settings for the calculation
     * @param trigonometricMode whether the input is in degrees ({@code DEG}) or radians ({@code RAD})
     * @param locale            the locale used for any locale-specific formatting
     * @return a new {@code BigNumber} representing sin(this)
     */
     ...
     * <p>This is a convenience method that delegates to {@link #asin(MathContext, TrigonometricMode, Locale)}.</p>
     *
     * @param trigonometricMode whether the result should be in degrees ({@code DEG}) or radians ({@code RAD})
     * @return a new {@code BigNumber} representing asin(this)
     */
     ...
     *
     * @param x the second coordinate for atan2(this, x)
     ...
     *
     * @param k the number of items to choose (must be between 0 and n inclusive)
     * @return a {@code BigNumber} representing C(n, k)
     * @throws IllegalArgumentException if {@code k > n} or either number has a decimal part
     */
     ...
     *
     * @param k           the number of items to choose (must be between 0 and n inclusive)
     * @param mathContext the context for precision and rounding
     ...
     *
     * @param k the number of elements to select and order (must be between 0 and n inclusive)
     * @return a {@code BigNumber} representing P(n, k)
     * @throws IllegalArgumentException if {@code k > n} or either value has a decimal part
     */
     ...
     * @param k           the number of elements to select and order (must be between 0 and n inclusive)
     * @param mathContext the context for precision and rounding
     * @param locale      the locale to use for formatting or parsing
     ...
     *
     * @param theta the angle (in degrees or radians, depending on this object's {@code trigonometricMode})
     ...
     *
     * @param theta             the angle (in degrees or radians, depending on {@code trigonometricMode})
     * @param mathContext       the context for precision and rounding
     * @param trigonometricMode whether the angle is in degrees or radians
     * @param locale            the locale for formatting or localization (used internally)
     ...
     * @throws IllegalArgumentException if {@code this} ≥ {@code max}, or if either value has decimal places
     */
     ...
     *
     * @param m the reference value to calculate the percentage from
     ...
     *
     * @param m           the value from which to calculate the percentage
     * @param mathContext the context specifying precision and rounding mode
     ...
     * using the instance's default {@link MathContext}.</p>
     *
     * @param n the reference value to calculate the percentage of
     ...
     * </p>
     *
     * @param other the other BigNumber to compute the GCD with
     ...
     *
     * @param mathContext the MathContext controlling precision and rounding mode
     ...
     * returns a single "0".
     *
     * @param string the string to trim leading zeros from
     ...
     *
     * @param string the string to trim trailing zeros from
    ...
    /**
     * Creates a new {@code BigNumber} instance from a {@code String}.
     *
     * @param string the string representing the number
     * @return a new {@code BigNumber} instance
     */
    public static BigNumber valueOf(@NonNull final String string) {
        return new BigNumber(string);
    }

    /**
     * Creates a new {@code BigNumber} instance from a {@code BigDecimal}.
     *
     * @param bigDecimal the {@code BigDecimal} representing the number
     * @return a new {@code BigNumber} instance
     */
    public static BigNumber valueOf(@NonNull final BigDecimal bigDecimal) {
