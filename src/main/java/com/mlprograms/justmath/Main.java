...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        BigNumber bigNumber1 = new BigNumber("12.3");
        BigNumber bigNumber2 = new BigNumber("45.7");
        BigNumberCoordinate coordinate = CoordinateConversionMath.polarToCartesianCoordinates(bigNumber1, bigNumber2, new MathContext(10, RoundingMode.HALF_UP), TrigonometricMode.DEG, Locale.GERMANY);
